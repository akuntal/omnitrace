...
const data = [
  {
    ...
    content1:
      'By installing OmniTrace, you are one step ahead in ensuring the safety of your own self, family, community, state and the country.',
  ...
  {
    title:
      'With OmniTrace, your data is never compromised and is only compared with the central database approved by the Govt of India.',
    content1:
